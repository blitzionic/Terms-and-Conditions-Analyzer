...
const systemPrompt = `
Please analyze the following Terms and Conditions text and identify the potential red flags. Identify them based on an intensity from safe to unsafe. Structure the output in the following JSON format:
